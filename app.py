...
if ticker_symbol and api_ready:
    try:
        st.info("🔄 正在從機構資料庫抓取高品質新聞，並請 AI 進行深度解讀...")
        ...
        if isinstance(news_list, list) and len(news_list) > 0:
            ...
            # Finnhub 已經幫我們過濾掉很多雜訊了，我們取最新且最具代表性的 3 篇
            ...
            st.caption("✅ 備註：目前資料來源為華爾街機構級 API (Finnhub)，為維持品質與效能，僅顯示近期最具關聯性的 3 則重大情報。")
        else:
